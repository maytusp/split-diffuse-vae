...
def train(config):
    ...
    vae = VAE(
        ...
        enc_block_str=config.split_model.enc_block_config,
        dec_block_str=config.split_model.dec_block_config,
        enc_channel_str=config.split_model.enc_channel_config,
        dec_channel_str=config.split_model.dec_channel_config,
        aux_enc_block_str=config.split_model.aux_enc_block_config,
        aux_dec_block_str=config.split_model.aux_dec_block_config,
        aux_enc_channel_str=config.split_model.aux_enc_channel_config,
        aux_dec_channel_str=config.split_model.aux_dec_channel_config,        

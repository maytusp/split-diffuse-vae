...
from models.diffusion import DDPM, DDPMv2, splitFinetuneDDPMWrapper, SuperResModel
...
def generate_recons(config):
    ...
    vae = VAE.load_from_checkpoint(
        config_vae.evaluation.dummy_chkpt_path,
    ...
    ddpm_wrapper = splitFinetuneDDPMWrapper.load_from_checkpoint(

...
from models.diffusion import DDPM, splitDDPMWrapper, UNetModel, SuperResModel
...
def sample(config):
    ...
    ddpm_type = config.evaluation.type
    assert ddpm_type == "form1"
    ...
    # Form 1
    z_dataset = UncondLatentDataset(
        (n_samples, 6, image_size, image_size),
    )
    # Setup devices
    test_kwargs = {}
    loader_kws = {}

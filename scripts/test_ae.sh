...
python main/test.py reconstruct --device cpu \
                                --dataset carla \
                                --image-size 128 \
                                --num-samples 64 \
                                --save-path /home/bias-team/Mo_Projects/DiffuseVAE/outputs/carla/vanilla_vae_recon/ \
                                --write-mode image \
                                /home/bias-team/Mo_Projects/DiffuseVAE/logs/vanilla_vae_carla_day/checkpoints/vae-carla_day-epoch=1499-train_loss=0.0000.ckpt \
